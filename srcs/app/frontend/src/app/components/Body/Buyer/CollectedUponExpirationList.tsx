/*
srcs/app/frontend/src/app/components/Body/Buyer/CollectedUponExpirationList.tsx
...
const CollectedUponExpirationList = () => {
...
export default CollectedUponExpirationList;