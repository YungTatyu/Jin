...
class BlockbookAPI extends baseWebsocket_1.BaseWebsocket {
    ...
    getBlockFilter(blockHash, filterParams) {
        return this.send('getBlockFilter', Object.assign({ blockHash, scriptType: 'taproot-noordinals' }, filterParams));
    }
    getBlockFiltersBatch(bestKnownBlockHash, pageSize, filterParams) {
        return this.send('getBlockFiltersBatch', Object.assign({ bestKnownBlockHash,
            pageSize, scriptType: 'taproot-noordinals' }, filterParams));
    }
    getMempoolFilters(fromTimestamp, filterParams) {
        return this.send('getMempoolFilters', Object.assign({ fromTimestamp, scriptType: 'taproot-noordinals' }, filterParams));
    }
