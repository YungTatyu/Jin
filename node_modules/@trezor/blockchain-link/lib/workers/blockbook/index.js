...
const getTransaction = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const api = yield request.connect();
    const rawtx = yield api.getTransaction(request.payload);
...
const getTransactionHex = (request) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const api = yield request.connect();
    const { hex } = yield api.getTransaction(request.payload);
    if (!hex)
    ...
    post({
        ...
        payload: {
            ...
            payload: {
                ...
                tx: account
                    ? utils.transformTransaction(event.tx, (_a = account.addresses) !== null && _a !== void 0 ? _a : account.descriptor)
...
const unsubscribeFiatRates = (_a) => tslib_1.__awaiter(void 0, [_a], void 0, function* ({ state, connect }) {
...
const unsubscribeMempool = (_a) => tslib_1.__awaiter(void 0, [_a], void 0, function* ({ state, connect }) {
